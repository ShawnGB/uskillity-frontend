export const en = {
  about: {
    header: "Vision:",
    body_0:
      "The world is influenced and shaped by how much information, knowledge and skills people have. Having a broader skill-set leads to innovation and improvement of daily life. It contributes to the achievement of personal fulfilment and the discovery of inner passions. It helps us to comprehend challenges and be more critical.",
    body_1:
      "Schools and traditional educational institutions do not always teach us the necessary practical skills, and also neglect to modernise what is being thought. Furthermore, the decline of vocational opportunities due to technological advances can only be hindered if skills are being thought that are of importance to the future, and reflect our human emotions which cannot be automated.",
    body_2:
      "We envision a world where learning and teaching are much more accessible, people-centred and inspiring. We are determined to create a community that motivates, inspires and enables people to easily and efficiently learn new skills and share their talents to help others grow.",
    body_3:
      "We truly believe in people and their abilities to inspire others. We know that for any change in the world to happen, it is up to all of us to make a difference.",
    body_4:
      "We are creating u/skillity to give people a platform through which we can influence the world for the better.",
    contact: {
      header: "Contact",
    ...
    guidelines: {
      ...
      body_1:
        "As a community of people from different backgrounds, races and genders it’s important that we are patient, empathetic, respectful of one another and that we accept everyones differences.",
      body_2: "BE KIND TO OTHERS",
      body_3:
        "Treat fellow community members the same way you would like them to treat you. Don’t swear, be vulgar, or aggressive towards others. Show people that you are welcoming and ready to make new friends.",
      body_4: "NO VULGAR OR INAPPROPRIATE COMMENTS",
      body_5:
        "At u/skillity we do not appreciate or accept vulgar or inappropriate comments. If for any reason you have a problem with any community member either try to resolve the issue by being kind and respectful or contact the u/skillity office.",
      body_6: "NO DISCRIMINATION, RACISM OR SEXISM",
      body_7:
        "In no case whatsoever is discrimination, racism or sexism acceptable. At u/skillity we respect and accept everybody equally regardless of their background, race or gender. It is not acceptable to create workshops that are excluding people or are representing a racist or sexist topic.",
      body_8: "NO ADVERTISING OR OTHER COMMERCIAL CONTENT",
      body_9:
        "We do support instructors, teachers as well as their institutions, but u/skillity is first and foremost for it’s community and therefore prohibits any advertising or other commercial content.",
      body_10: "NO SPAM",
      body_11: "No unwanted messages or content posted on u/skillity.",
      body_12: "NO ILLEGAL OR HARMFUL CONTENT OR ACTIVITY",
      body_13:
        "No content that promotes illegal or harmful activity or is threatening, harassing, vulgar, obscene or profane.",
      body_14: "NO FAKE ACCOUNTS",
      body_15:
        "Fake accounts or the act of impersonating other people is prohibited.",
      body_16: "NO ILLEGAL CONTENT",
      body_17:
        "Illegal content or copyrighted content, meaning content whose legal rights belong to somebody else, is prohibited.",
      body_18: "FEEDBACK IS APPRECIATED",
      body_19:
        "Feedback in the form of reviews and ratings is very much appreciated, that is how we at u/skillity and our Skill-Sharers will know how to improve and reach your expectations and needs.",
      body_20: "NO REVIEWS THAT DO NOT REPRESENT PERSONAL EXPERIENCES",
      body_21:
        "If you have not attended a workshop, or have experienced u/skillity first hand, you may not state your opinion and publish a review or rating.",
      body_22:
        "NO REVIEWS THAT WERE PROMISED IN EXCHANGE FOR PAYMENT OR OTHER SERVICES",
      body_23:
        "Paying users, or any individual or service, or offering your own services, to post a review or rank on a workshop or instructor is highly prohibited.",
      body_24: " NO CONTENT THAT IS OFF-TOPIC",
      body_25:
        "Content that is of no relation to the workshop, or topic in hand, is prohibited from the platform.",
      body_26: "NO TROLLING OR TARGETING COMMUNITY MEMBERS",
      body_27:
        "Offensive or provocative trolling or targeting of community members is highly prohibited.",
      body_28: "UNDERAGE USERS",
      body_29:
        "Users that are under the age of 18 are only allowed to use the platform with the consent of their parents. When you register your profile you will be asked to confirm that you are over the age of 18. Abusing this rule can result in legal consequences.",
      body_30: "DELETE PROFILE",
      body_31:
        "Oh noooo, it makes us very sad that you are thinking about not being part of our community. But if you really wish to delete your profile please e-mail us on office@uskillity.de with your inquiry."
    },
    help: {
      header: "Help",
      ...
      body_2:
        "Sometimes we master an ability just by mere life-experience. Therefore u/skillity is open to any qualifications as long as you feel like you can contribute to the learning community by sharing your skill. We are confident in peoples qualities but urge Instructors to be transparent and communicate their background to the learners.",
      body_3:
      ...
      body_27:
        "If you have any further questions please e-mail us on office@uskillity.de"
    },
    press: {
      header: "Press",
      body_0:
        "Do you want to do a story on us? Have you already written about us and what to share?",
      body_1:
        "For any press related inquiries please e-mail us on press@uskillity.de "
    },
    sidebar: {
      team: "Vision",
      contact: "Contact",
    ...
    team: {
      header: "Team",
      body_0:
        "For both Shawn and Irina, sitting for hours behind a desk in a classroom was one of the most tedious endeavours. They both found inspiration from activities they got to do away from the educational institutions, in environments that let them express their individuality and amplify their creativity.",
      body_1:
        "Shawn’s motivation was triggered by his difficulty resonating with the traditional school system. Rebelling against classical learning, he impelled into the professional world without a fancy diploma in his pocket and experienced obstacles finding ways to learn practical skills away from educational institutions. Moreover, he struggled to find personal fulfilment and passion in the current overly-structured and conservative educational environment.",
      body_2:
      ...
      body_3:
        "Shawn and Irina’s different experiences and backgrounds brought a common thread in light. They both share a love for learning but they do not resonate with the way knowledge is stimulated and passed on. They both believe that knowledge shouldn’t be a privilege, people should be able to experience many different skills in order to find their passion. Learning should be tailored to the individual’s habits and affinities.",
      body_4:
  ...
  home: {
    ...
    body_1:
      "Our mission is to empower people to more efficiently share and learn skills, so that together we can influence the world for the better."
  },
  profile: {
  ...
  share_skill: {
    ...
    additional_requirements_placeholder:
